...
if(command === "help"){
  ...
  .setColor("000000")
  .setTitle("Help!")
  .addField("s!help", "La commande d'aide du bot")
  .addField("s!invitatiom", "La commande d'invitation du bot")
  .addField("s!info", "Donne des info sur le bot")
  .addField("s!say", "Le bot répétera ce que vous dites !")//
  .addField("s!ping", "Donne le ping")
  .addField("s!avatar", "Montre votre avatar")
  .addField("s!serverinfo", "Montre les info du serv")
  .addField("s!clear", "Efface des message!")
  .addField("s!ban", "Bannez une personne")
  .addField("s!kick", "Kickez une personne")
  .addField("s!8ball", "Avez une question? 8ball va vous repondre!")
  .addField("s!reporterror", "Reportez une erreur sur le discord de Saturn!")
  .addField("s!errormp", "Envoie une erreur directement a LunatiikXD.")
  ...
  message.channel.send(help_embed);
    ...
    .addField("Version du bot:","Beta 0.0.1")
